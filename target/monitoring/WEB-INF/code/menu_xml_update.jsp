				...
				<table style="width: 100%;">
					...
					<tbody>
						<tr>
							...
							<td><select id="sel_metas" style="width: 250px;" /></td>
			...
			<div class="body">
					...
					<table style="width: 100%;">
						...
						<tbody>
							<tr>
								...
								<td><input type="text" id="input_metaValue"
									style="width: 100%;" placeholder="속성값을 입력해 주십시오."></td>
							</tr>
						</tbody>
					</table>
				</div>
				<div class="opt">
					<table style="width: 100%;">
						...
						<tbody>
							<tr>
								<td><span class="label">수정될 속성</br>(메뉴ID/회사코드)</span></td>
				...
				<div class="type">
					<table>
						...
						<tr>
							<td>
								<button class="btn2" id="btn-submit">
									<span>재설정</span>
								</button>
							</td>
						</tr>
			...
			function() {
				...
				$('#sel_metas').change(
						function() {
							$('#meta_info1').empty()
									.text(
											$('#sel_metas option:selected')
													.attr('tag'));
							$('#input_metaValue').val('');
							selectMenucodeByMeta();
						});

				tableMenu = $('#grid_table_menu').DataTable({
					scrollY : 0,
					searching : true,
					paging : false,
					info : false,
						...
						.on(
								...
								function() {
									...
									if (menu_list.length < 1) {
										...
										if (confirm('선택하신 메뉴의 속성을 변경 하시겠습니까?'))
											updateMetaValues(menu_list,
													company_list);
