...
//			}
		...
		"rowCallback": function( row, data, index ) {
		 if ( data["LOG_LEVEL"] == "ERROR" ){
		  ...
		  else if ( data["MESSAGE"].indexOf("PARAMETERS") > -1 || data["MESSAGE"].indexOf("SCP") > -1 || data["MESSAGE"].indexOf("DETECT") > -1 || data["MESSAGE"].indexOf("extract_request_info") > -1 ||  data["MESSAGE"].indexOf("page_num") > -1 ||  data["MESSAGE"].indexOf("Initial") > -1 )
		    {
